from algos.lpopl import _initialize_policy_bank, _test_LPOPL, _test_LPOPL_parallel
import argparse
...
if __name__ == "__main__":
    ...
    numpy.random.seed(1)
    random.seed(1)
    result = _test_LPOPL_parallel(task, learning_params, testing_params, policy_bank, do_render=False)
    print(result)
